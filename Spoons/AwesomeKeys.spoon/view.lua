...
-- @param style a table indicating how to display the alert:
...
-- strokeWidth
-- strokeRadius
-- @param screenObj the screen object where to show the alert such as `hs.screen.mainScreen()`
local showAlert = function(message, style, screenObj)
	...
	local padding = style.padding or style.fontSize / 2
